...
/**
 * This is an interface I created in order to have a single interface that I
 * could pass in the Paste builder language, that would populate a lot of
 * different sets, or populate the conditions for a handful of different routes
 * that had been split by an or.
 * <p>
 * This is outgiong.
 * <p>
 * Because I can just as easily pass around a list or a list of lists in Paste
 * and this interface won't exist to confuse me.
 * 
 * @author Alan Gutierrez
 * 
 * @param <T>
 *            The type conditionally mapped.
 */
